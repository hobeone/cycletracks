module Inplace
  module InstanceMethods
    ...
    def editable_content_tag(element_type, object, property, editable = false,
                             url = nil, initial_default_text = nil, element_options = {},
                             edit_options = {}, ajax_options = {})
    ...
    def editable_collection_tag(element_type, object, property, select_entries,
                                element_options = {},
                                edit_options = {}, ajax_options = {})
      object_name = object.class.to_s.underscore
      element_options ||= {}
      ...
      tg += <<-EOJS
        <script type="text/javascript">\n
          new Ajax.InPlaceCollectionEditor(
            ...
            {
              ajaxOptions:  {#{options_for_ajax}},
              collection: #{select_entries.to_json},
              callback: function(form, value) {
                return "#{object_name}[#{property}]=" + encodeURIComponent(value) + "#{put_params}"
              },
              onComplete: function(transport, element) {
